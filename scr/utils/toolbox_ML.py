...
def tipifica_variables(df, umbral_categoria, umbral_continua):
    ...
    if type(umbral_categoria) != int:
        raise TypeError(f'El valor de "umbral_categoria", primer input tras df, debe ser de tipo {int}, pero recibió de tipo {type(umbral_categoria)}')

    elif type(umbral_continua) != float:
        raise TypeError(f'El valor de "umbral_continua",segundo input tras df, debe ser de tipo {float}, pero recibió de tipo {type(umbral_continua)}')
